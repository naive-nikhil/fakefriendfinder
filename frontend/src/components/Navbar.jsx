const Navbar = () => {
  return (
    <div className="flex relative w-full overflow-hidden bg-[#f8e8d1]">
      ...
      <div className="text-freckle flex items-center text-3xl/6 rounded-b-xl py-1 h-fit tracking-tighter [-webkit-text-stroke:0.2px_black] px-2 bg-[#f93943] w-fit text-white [text-shadow:_-2px_2px_0_rgb(0_0_0_/_0.8)]">
        FAKE
        <br />
        FRIEND
        <br />
